          ...
          : (<div className="w-full h-full text-center absolute top-[75%]">
            <div className="swipe-btn-fade-in">
              <div className="text-center">
                <div role="status">
                  <svg aria-hidden="true" className="inline w-8 h-8 text-purple-400 animate-spin dark:text-gray-600 fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
