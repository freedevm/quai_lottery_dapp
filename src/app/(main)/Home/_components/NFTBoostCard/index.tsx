...
export default function NFTBoostCard({ index, nftName, userNFTs, setSelectedNFTs }: Props) {
  ...
  useEffect(() => {
    setSelectedNFTs((prev) => {
      const index = prev.findIndex(item => item.id === nftName);
      prev.splice(index, 1, {id: nftName, count: count});
      return prev;
    });
